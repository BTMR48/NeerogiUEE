...
class ViewOneUserArticleScreen extends StatefulWidget {
  const ViewOneUserArticleScreen({Key? key, required this.id})
      : super(key: key);
  final String id;

  @override
  State<ViewOneUserArticleScreen> createState() =>
      _ViewOneUserArticleScreenState();
}

class _ViewOneUserArticleScreenState extends State<ViewOneUserArticleScreen> {
  Articles? oneArticle;
  bool loading = false;
